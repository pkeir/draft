...
namespace std {
  ...
  template<class T1, class D1, class T2, class D2>
    constexpr bool operator<(const unique_ptr<T1, D1>& x, const unique_ptr<T2, D2>& y);       // freestanding
  template<class T1, class D1, class T2, class D2>
    constexpr bool operator>(const unique_ptr<T1, D1>& x, const unique_ptr<T2, D2>& y);       // freestanding
  template<class T1, class D1, class T2, class D2>
    constexpr bool operator<=(const unique_ptr<T1, D1>& x, const unique_ptr<T2, D2>& y);      // freestanding
  ...
  template<class T, class U>
    constexpr shared_ptr<T> reinterpret_pointer_cast(const shared_ptr<U>& r) noexcept;
  template<class T, class U>
    constexpr shared_ptr<T> reinterpret_pointer_cast(shared_ptr<U>&& r) noexcept;
...
namespace std {
  ...
  public:
    ...
    constexpr size_t owner_hash() const noexcept;
    template<class U>
...
template<class T> shared_ptr<T>
  constexpr make_shared(size_t N);                                        // \tcode{T} is \tcode{U[]}
template<class T, class A>
  constexpr shared_ptr<T> allocate_shared(const A& a, size_t N);          // \tcode{T} is \tcode{U[]}
\end{itemdecl}
...
template<class T>
  constexpr shared_ptr<T> make_shared(size_t N, const remove_extent_t<T>& u);       // \tcode{T} is \tcode{U[]}
template<class T, class A>
  constexpr shared_ptr<T> allocate_shared(const A& a, size_t N, const remove_extent_t<T>& u);   // \tcode{T} is \tcode{U[]}
\end{itemdecl}
...
namespace std {
  struct owner_hash {
    template<class T>
      constexpr size_t operator()(const shared_ptr<T>&) const noexcept;

    template<class T>
      constexpr size_t operator()(const weak_ptr<T>&) const noexcept;
...
\begin{itemdecl}
template<class T>
  constexpr size_t operator()(const shared_ptr<T>& x) const noexcept;
template<class T>
  constexpr size_t operator()(const weak_ptr<T>& x) const noexcept;
\end{itemdecl}
...
\begin{itemdecl}
constexpr template<class T, class D> struct hash<unique_ptr<T, D>>;
\end{itemdecl}
